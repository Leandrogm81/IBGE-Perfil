...
st.info(
    "A consulta pode demorar de 2 a 5 minutos dependendo do estado selecionado. "
    "Evite mudar de estado durante o carregamento. Aguarde o carregamento completo!"
)
...
# Parâmetro de filtro por população mínima
min_pop = st.slider(
    "População mínima do município", min_value=0, max_value=50000, value=0, step=1000
)
...
with st.spinner("Consultando municípios... (pode demorar alguns minutos)"):
    for nome, cod in mun_lista:
        try:
